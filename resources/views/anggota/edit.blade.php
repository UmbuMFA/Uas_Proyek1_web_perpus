                      ...
                      <h4 class="card-title">Edit Anggota</h4>
                        ...
                        <div class="form-group{{ $errors->has('prodi') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="prodi" required="">
                                <option value=""></option>
                                <option value="IPA" {{$data->prodi === "IPA" ? "selected" : ""}} >Ilmu Pengetahuan Alam</option>
                                <option value="IPS" {{$data->prodi === "IPS" ? "selected" : ""}} >Ilmu Pengetahuan Sosial</option>
                                <option value="BAHASA" {{$data->prodi === "BAHASA" ? "selected" : ""}} >Bahasa</option>
                            </select>
                            </div>
                        </div>
